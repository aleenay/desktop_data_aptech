...
namespace WebApplication6_2207G1.Controllers
{
    public class TblCategoriesController : Controller
    {
        ...
        public TblCategoriesController(db_2207b2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.TblCategories != null ? 
                          ...
                          Problem("Entity set 'db_2207b2Context.TblCategories'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'db_2207b2Context.TblCategories'  is null.");
            }
            var tblCategory = await _context.TblCategories.FindAsync(id);
            if (tblCategory != null)
            {
