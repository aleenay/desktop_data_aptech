...
namespace crud_withimg.Controllers
{
    public class TblUsersController : Controller
    {
        ...
        public TblUsersController(db_2202f2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.TblUsers != null ? 
                          ...
                          Problem("Entity set 'db_2202f2Context.TblUsers'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,Password")] TblUser tblUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,Password")] TblUser tblUser)
        {
            if (id != tblUser.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'db_2202f2Context.TblUsers'  is null.");
            }
            var tblUser = await _context.TblUsers.FindAsync(id);
            if (tblUser != null)
            {
