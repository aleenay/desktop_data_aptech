...
namespace db_first_approach_2202E2.Controllers
{
    public class TblStdsController : Controller
    {
        ...
        public async Task<IActionResult> Create(IFormFile imageFile,[Bind("StdId,StdName,StdAge,StdEmail,StdCity,StdProfile")] TblStd tblStd)
        {
            if (ModelState.IsValid)
            {
                ...
                //{
                //    await imageFile.CopyToAsync(fileSrteam);
                //}
